        ...
        {services.length > 0 && (
          <div className="relative mb-6">
            ...
            <input
              ...
              className="w-full pl-11 pr-4 py-3.5 bg-white border border-slate-200 rounded-2xl text-slate-700 font-medium placeholder:text-slate-400 outline-none focus:ring-2 focus:ring-indigo-500 focus:border-transparent shadow-sm transition-all"
            />
            {search && (
          ...
          <div className="flex flex-col items-center justify-center py-20 text-center space-y-4">
            ...
            <div>
              ...
              <p className="text-slate-400 font-medium text-sm mt-1">
                {search ? 'Tente outro termo de busca.' : 'Clique em "Novo Serviço" para começar.'}
              </p>
            </div>
          </div>
        ) : (
                  ...
                  <div className="group flex flex-col sm:flex-row sm:items-center justify-between gap-4 p-5 bg-white rounded-2xl border border-slate-100 shadow-sm hover:shadow-md hover:border-indigo-100 transition-all duration-200">
                    <div className="flex items-start gap-4 flex-1 min-w-0">
                      ...
                      <div className="min-w-0">
                        ...
                        {s.description && (
                          <p className="text-sm text-slate-500 font-medium mb-1.5 leading-relaxed">{s.description}</p>
                        )}
