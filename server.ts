...
async function startServer() {
  ...
  // ROTAS DO ASAAS MIGRADAS PARA SUPABASE EDGE FUNCTIONS:
  // - app.post("/api/financeiro/criar-cobranca", ...)
  // - app.get("/api/financeiro/obter-pix-qrcode/:paymentId", ...)
  // - app.post("/api/webhooks/asaas", ...)
  // Consulte supabase/functions/asaas-integration/index.ts
