...
BEGIN
  ...
  -- Validação de Segurança removida para permitir que Admins testem a plataforma
  -- e para evitar bloqueios ao comprar infoprodutos.
  -- O Postgres continuará impedindo e-mails duplicados na tabela auth.users se a constraint existir,
  -- mas não bloquearemos a criação na tabela patients.
